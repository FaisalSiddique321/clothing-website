  ...
  <section id="testimonials" className="testimonials-section">
    ...
    <div className="testimonials-container">
      <div className="testimonial-card">
        <Image src="/R.jpeg" alt="John Doe" className="testimonial-image" />
      ...
      <div className="testimonial-card">
        <Image src="/R.jpeg" alt="Jane Smith" className="testimonial-image" />
      ...
      <div className="testimonial-card">
        <Image src="/R.jpeg" alt="Alex Lee" className="testimonial-image" />
